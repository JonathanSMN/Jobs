...
import 'schema/vaga_record.dart';
...
export 'schema/vaga_record.dart';
export 'schema/usuario_record.dart';

/// Functions to query VagaRecords (as a Stream and as a Future).
Future<int> queryVagaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VagaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VagaRecord>> queryVagaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      VagaRecord.collection,
      VagaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VagaRecord>> queryVagaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
