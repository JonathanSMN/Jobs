                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 4.0, 20.0, 12.0),
                                        child: Text(
                                          'Abaixo você encontrará as vagas postadas recentemente',
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall,
                                        ),
                                      ),
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 0.0, 12.0),
                                        child: StreamBuilder<List<VagaRecord>>(
                                          stream: queryVagaRecord(),
                                          builder: (context, snapshot) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemCount:
                                                  listViewVagaRecordList.length,
                                              itemBuilder:
                                                  (context, listViewIndex) {
                                                final listViewVagaRecord =
                                                    listViewVagaRecordList[
                                                        listViewIndex];
                                                return Padding(
